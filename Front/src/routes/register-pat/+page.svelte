      ...
      <form on:submit|preventDefault={inscrire}>
        ...
        <div class="row2">
          ...
          <div class="field">
            ...
            <input id="prenom" type="text" bind:value={prenom} placeholder="Ex: Amina" class:error={erreur.prenom} />
        ...
        <div class="row2">
          <div class="field">
            ...
            <input id="ville" type="text" bind:value={ville} placeholder="Ex: Casablanca" class:error={erreur.ville} />
            {#if erreur.ville}<span class="err-msg">{erreur.ville}</span>{/if}
          </div>
          <div class="field">
            <label for="adresse">Adresse <span class="opt">(optionnel)</span></label>
            <input id="adresse" type="text" bind:value={adresse} placeholder="Ex: 12 rue des Fleurs" />
          </div>
        </div>
        ...
        <div class="field">
          ...
          <input id="email" type="email" bind:value={email} placeholder="Ex: patient@email.com" class:error={erreur.email} />
