    ...
    <form on:submit|preventDefault={continuer}>
      ...
      <div class="row2">
        <div class="field">
          ...
          <input id="nom" type="text" bind:value={nom} placeholder="Ex: Benali" class:error={erreur.nom} />
          {#if erreur.nom}<span class="err-msg">{erreur.nom}</span>{/if}
        </div>
        <div class="field">
          <label for="prenom">Prénom <span class="req">*</span></label>
          <input id="prenom" type="text" bind:value={prenom} placeholder="Ex: Karim" class:error={erreur.prenom} />
      ...
      <div class="row2">
        ...
        <div class="field">
          ...
          <input id="ville" type="text" bind:value={ville} placeholder="Ex: Meknès" class:error={erreur.ville} />
      ...
      <div class="field">
        ...
        <input id="adresse" type="text" bind:value={adresse} placeholder="Ex: 12 rue des Hôpitaux, Meknès" class:error={erreur.adresse} />
      ...
      <div class="field">
        ...
        <input id="telephone" type="tel" bind:value={telephone} placeholder="Ex: +212 6 12 34 56 78" class:error={erreur.telephone} />
        {#if erreur.telephone}<span class="err-msg">{erreur.telephone}</span>{/if}
      </div>

      <div class="field">
        <label for="email">Adresse email <span class="req">*</span></label>
        <input id="email" type="email" bind:value={email} placeholder="Ex: docteur@email.com" class:error={erreur.email} />
      ...
      <div class="row2">
        <div class="field">
          ...
          <input id="password" type="password" bind:value={password} placeholder="Min. 8 caractères" class:error={erreur.password} />
          {#if erreur.password}<span class="err-msg">{erreur.password}</span>{/if}
        </div>
        <div class="field">
          <label for="confirmer">Confirmer <span class="req">*</span></label>
          <input id="confirmer" type="password" bind:value={confirmerMotdepasse} placeholder="Répéter" class:error={erreur.confirmerMotdepasse} />
